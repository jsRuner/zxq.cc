        ...
        .btn-success {
            ...
            *background-color: #51a351;
            ...
            filter: progid:dximagetransform.microsoft.gradient(enabled=false)
                        ...
                        <form id="target" class="form-horizontal" method="post" action="<?php echo site_url("football/add_form");?>">
                            <fieldset>
                                <div id="legend" class="">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" placeholder="2016年2月25日" class="input-xlarge" name="football_date"  onfocus="setday(this)" readonly="readonly">
