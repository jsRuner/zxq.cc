    ...
    <style>
        ...
        .form-control[disabled],fieldset[disabled] .form-control {
            cursor: not-allowed
                        ...
                        <form id="target" class="form-horizontal" method="post" action="<?php echo site_url('football/peilv_editor_form')?>">
...
<!--                                </div>-->
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="form-control" disabled type="text" placeholder="比赛编号"  style="width: 270px;"  value="<?php echo $footballinfo['football_code']?>">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" placeholder="胜" class="input-xlarge" name="peilv_win" value="<?php echo $football_peilvinfo['peilv_win'];?>">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" placeholder="平" class="input-xlarge" name="peilv_draw" value="<?php echo $football_peilvinfo['peilv_draw'];?>">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" placeholder="负" class="input-xlarge" name="peilv_fail" value="<?php echo $football_peilvinfo['peilv_fail'];?>">
